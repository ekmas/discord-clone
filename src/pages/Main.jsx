  ...
  return (
    <MainContext.Provider value={{ myName, allUsers }}>
      ...
      <div
        ...
        className={
          loading
            ? 'select-none w-screen h-screen z-50 opacity-100 visible fixed flex flex-col items-center justify-center top-0 left-0 bg-black-3'
            : 'select-none w-screen h-screen invisible z-50 flex items-center justify-center flex-col opacity-0 fixed top-0 left-0 bg-black-3'
        }
      >
