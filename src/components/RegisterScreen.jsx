...
export default function RegisterScreen({ activeDiv, setActiveDiv }) {
  ...
  return (
    <div
      className={
        activeDiv === 'reg'
          ? 'w-[480px] regform:px-4 min-h-[550px] rounded-main bg-main-gray text-white p-8 active'
      ...
      <form onSubmit={handleRegSubmit}>
        ...
        <div className="mt-5">
          ...
          <div
            ...
            className="text-link text-sm font-medium hover:underline cursor-pointer"
          >
