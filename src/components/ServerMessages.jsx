...
export default function ServerMessages({ activeChannelName }) {
  ...
  useEffect(() => {
    const messagesQuery = query(collection(db, activeChannelName), orderBy('createdAt'))
    ...
    <div className='h-full'>
        <div className='bg-main-gray h-[calc(100vh-117px)] pb-5 overflow-y-scroll chatbar text-overlay-text'>
            <div className='m-4 mb-6'>
                ...
                <h3 className="text-white font-bold text-[32px] leading-10 mt-[7px] mb-[6px] m600:text-[25px]" >Welcome to #{activeChannelName}!</h3>
