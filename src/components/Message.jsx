    ...
    <div className='px-4 m400:px-2 mt-[17px] py-1 hover:bg-gray-11'>
        ...
        <div className='flex flex-col min-h-[44px]'>
            <div className='flex items-center'>
                <button className='btn msgbtn font-medium leading-[22px] mr-1.5 text-white w-min'>{sender}</button>
                <p className='font-medium text-xs m400:text-[10px] text-gray-14 leading-[22px]'>{date}</p>
            </div>
